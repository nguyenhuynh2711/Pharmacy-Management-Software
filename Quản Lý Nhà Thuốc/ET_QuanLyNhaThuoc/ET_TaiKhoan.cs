...
namespace ET_QuanLyNhaThuoc
{
    public class ET_TaiKhoan
    {
        ...
        public ET_TaiKhoan(int idTaiKhoan, string hoTenTaiKhoan, string email, string matKhau,string soDienThoaiTaiKhoan, string diaChi, DateTime? ngaySinh, int maLoai, DateTime ngayTao)
        {
